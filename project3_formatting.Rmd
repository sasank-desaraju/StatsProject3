...
<<<<<<< Updated upstream
  geom_text(aes(label=if_else(.cooksd>=3*mean(.cooksd) & .hat>= 2*avg_hatMoca,
...
=======
* Using the general rule of thumb for highlighting outliers of 3*(average Cooks Distance), we do see points that pass that threshold. The points have high leverage and influence based on having a high .hat value past 3 times the average cooks distance (leverage), along with being approximately two standard deviations away from zero.
