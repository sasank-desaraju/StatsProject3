...
## Question 1
In the planned analyses, we looked at how different tests and self reported scores affected metrics like memory or attention, or how those affect other factors. Now, it would be interesting to look at how cognitive scores, like Moca scores, are  potentially impacted by the previous factors of interest (memory and attention) along with different symptoms of Mild Cognitive Impairment, such as ability to concentrate and indecisiveness. Analysis will be done on various self reported scores to see if a relationship exists.
...
```{r Cook's plots, remove one point at a time}
