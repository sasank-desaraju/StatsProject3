...
# Expanded Exploratory Analyses: Question 1 continued
...
All of the models have similar AIC values, however, the one with the lowest AIC is the model that excluded age. This model will be used to base the conclusions on. Given that, we can conclude that Moca scores decrease with decreasing memory performance.
